  ...
  return (
    <>
      ...
      <section className="relative flex min-h-dvh flex-col overflow-hidden bg-ink pt-16 lg:hidden">
        ...
        <div className="relative flex flex-1 flex-col items-center justify-end px-6 pb-8 pt-4">
          <motion.h1
      ...
      <section className="relative hidden overflow-hidden bg-ink lg:flex lg:min-h-dvh lg:flex-col lg:pt-[72px]">
        <div
          ...
          style={{ height: "min(56.25vw, calc(100dvh - 72px - 190px))" }}
        >
          <video
            className="h-full w-full object-cover"
        ...
        <Container className="relative flex flex-1 flex-col items-center justify-end pb-10">
          <motion.h1
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, delay: 0.08, ease: [0.16, 1, 0.3, 1] }}
            className="mx-auto max-w-3xl text-center font-display text-3xl font-medium leading-[1.1] tracking-tight text-mist xl:text-4xl"
          >
            {hero.headline} <span className="text-gradient">{hero.headlineAccent}</span>
          </motion.h1>
