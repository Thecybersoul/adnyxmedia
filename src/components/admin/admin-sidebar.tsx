...
import { LayoutDashboard, MapPin, Image as ImageIcon, LogOut, ExternalLink } from "lucide-react";
...
export function AdminSidebar() {
  ...
  return (
    <aside className="flex w-64 shrink-0 flex-col border-r border-white/10 bg-ink-soft">
