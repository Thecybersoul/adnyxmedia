...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, #e65050 0%, #c13c3c 100%); padding: 30px; border-radius: 12px 12px 0 0; text-align: center;">
    <h1 style="color: white; margin: 0; font-size: 24px;">New ADNYX Enquiry</h1>
  </div>
  
  <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 12px 12px;">
    <h2 style="color: #c13c3c; margin-top: 0;">Contact Details</h2>
    ...
    <table style="width: 100%; border-collapse: collapse;">
      ...
      <tr>
        ...
        <td style="padding: 12px 0; border-bottom: 1px solid #e0e0e0;"><a href="mailto:${escapeHtml(data.email)}" style="color: #c13c3c;">${escapeHtml(data.email)}</a></td>
      </tr>
      ${data.phone ? `
      <tr>
        <td style="padding: 12px 0; border-bottom: 1px solid #e0e0e0;"><strong>Phone:</strong></td>
        <td style="padding: 12px 0; border-bottom: 1px solid #e0e0e0;"><a href="tel:${escapeHtml(data.phone)}" style="color: #c13c3c;">${escapeHtml(data.phone)}</a></td>
      </tr>
      ` : ""}
      ${data.budget ? `
      <tr>
    ...
    <h2 style="color: #c13c3c; margin-top: 30px;">Message</h2>
    <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #c13c3c; white-space: pre-wrap;">${escapeHtml(data.message)}</div>
